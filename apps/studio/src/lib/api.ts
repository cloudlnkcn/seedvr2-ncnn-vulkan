...
export type ImageModel = { installed: boolean; worker_available: boolean; profile: string; model_verified: false; sizes: number[]; video: boolean; max_queued: number; video_model?: { installed: boolean; sizes: number[]; max_frames: number } };
