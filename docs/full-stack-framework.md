...
本页保留 0.8-media-jobs / 0.5.0-video-preview 的应用框架设计及当时的数值状态。0.6.0 已增加可安装的共享 SDK、公共预检与模型复制；当前公共边界和源码导航以 [ARCHITECTURE.md](ARCHITECTURE.md) 为准，最新数值修复见 [NUMERICS-REPAIR.md](NUMERICS-REPAIR.md)，早期交付证据见 [DELIVERY-RESULTS.md](DELIVERY-RESULTS.md)。
