...
def main():
    ...
    rows = []
    for source, target in [(64, 128), (128, 64), (96, 128), (160, 128), (257, 128), (192, 64), (64, 80), (129, 128)]:
    ...
    report = dict(schema_version='seedvr2-preprocessing-reference-v2', torch_version=torch.__version__,
